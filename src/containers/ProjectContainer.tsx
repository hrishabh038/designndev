    ...
    <div className={twMerge("bg-slate-600 p-6 lg:p-8 rounded-2xl flex flex-col lg:flex-row gap-4", props.bgColor)}>
      <div className="w-full">
        ...
        <div className="flex flex-col gap-4 items-end">
          <div className="aspect-[4/3] w-[400px] bg-white/25 hidden lg:block rounded-lg"></div>
          <div className="aspect-[4/2] w-full bg-white/25 rounded-lg"></div>
        </div>
      </div>
      <div className="w-full flex flex-col gap-8">
        <div className="aspect-[4/2.7] w-full bg-white/25 hidden lg:block rounded-lg"></div>
